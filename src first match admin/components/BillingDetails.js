...
import '../App.css';
import { fetchBillingStatus, configureBilling, fetchAllRecords, getRecord, downloadAllRecords, getOrderDownload, downloadReportCSV } from '../api/api';
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                {config ? (
                    <form onSubmit={this.configBilling}>
                        ...
                        <div className=" ml-4">
                                ...
                                <div className="col-sm-4">
                                    <div className="form-check">
                                        <input
                                            ...
                                            value="monthly"
                                            checked={this.state.billing_cycle == 'monthly'}
                                        />
                                    ...
                                    <div className="form-check">
                                        <input
                                            ...
                                            id="exampleRadios1"
                                            value="15th to 15th"
                                            checked={this.state.billing_cycle == '15th to 15th'}
                                        />
                                        <label className="form-check-label">15th to 15th</label>
                                    </div>
                                </div>
                            </div>
                            <div className="form-group row">
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-1 input-group mb-3">
                                    ...
                                    <input type="text" onChange={this.handleChange} value={this.state.other_charges} name="other_charges" className="form-control " required />
                                </div>
                                <div className="col-sm-8">
                                    Please enter an amount which needs to be used in the calculation per billing cycle. This value can be a positive or negative number or a zero too. This value acts
                                    as a monthly discount on the overall billing amount.
                                </div>
                            </div>
                            ...
                            <div className="form-group row">
                                <div className="col-sm-4 ml-5">
                                    ...
                                    <button type="submit" className={`button-pop ml-3 ${btnvisible} `} onClick={this.onBack}>
                                        back
                                    </button>
                                </div>
                            </div>
                    ...
                    <>
                            ...
                            <div className="row p-2 ml-0 mr-0 bd-highlight align border border-primary">
                                ...
                                <div className="form-check col col-3 p-3 form-check-inline ml-3">
                                    <div className="d-flex justify-content-end">
                                        <Link to="#" onClick={this.onConfigure}>
                                            Configure
                                        </Link>
                                    </div>
                                </div>
                            ...
                            {this.state.allRecords && this.state.allRecords.response && this.state.singlerecord.response ? (
                                <>
                                    <p className="mt-4 ml-3">
                                        Order report for {this.state.org_name}. {this.state.singlerecord && this.state.singlerecord.response.started_on.slice(0, 10)} to{' '}
                                        {this.state.singlerecord && this.state.singlerecord.response.completed_on.slice(0, 10)}. Order ID - {this.state.singlerecord.response.id}
                                    </p>
                                    <div className="table-responsive">
                                        ...
                                        <div className="form-group row d-flex justify-content-center mr-3">
                                            <button className="btn btn-primary" data-id={this.state.record_id} onClick={this.downloadReport}>
                                                Download CSV
                                            </button>
                                            <button type="submit" className="btn btn-primary ml-3" onClick={this.onBack}>
                                                back
                                            </button>
                                        </div>
                                    </div>
                                ...
                                this.state.allRecords.response && (
                                    <>
                                        <p className="mt-4 ml-3">
                                            Order report for {this.state.org_name}. {this.state.displayFrom} to {this.state.displayTo}.​
                                        </p>
                                        ...
                                        <div className="table-responsive col-4">
                                                ...
                                                <tbody>
                                                    {this.state.allRecords.response.length > 0
                                                        ? this.state.allRecords.response.map((q, index) => (
                                                              <tr key={index} className="text-center">
                                                                  <td data-id={q.id} onClick={this.singleRecord}>
                                                                      {q.id}
                                                                  </td>
                                                                  <td>
                                                                      {q.started_on.slice(0, 10)} to {q.completed_on.slice(0, 10)}
                                                                  </td>
                                                              </tr>
                                                          ))
                                            ...
                                            <div className="form-group row d-flex justify-content-center mr-3">
                                                <button className="btn btn-primary mr-3" onClick={this.downloadOrder}>
                                                    Download CSV
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <form>
                                ...
                                <div className="row p-4 mt-4 ml-0 mr-0 bd-highlight align border border-primary">
                                    <div className="form-check col-2 form-check-inline ml-3">
                                        <label className="form-check-label">Order Report:</label>
                                    </div>
                                    ...
                                    <div className="form-check col-3 form-check-inline ">
                                        ...
                                        <DatePicker selected={this.state.endDate} onChange={(date) => this.setEndDate(date)} placeholderText={'mm/dd/yyyy'} showYearDropdown scrollableYearDropdown />
                                    </div>
                                    <div className="form-check col-2 form-check-inline ">
                                        <div>
                                            <Link to="#" onClick={this.onLoad}>
                                                Load
                                            </Link>
                                        </div>
                                    </div>
                        ...
                        <div className="form-group row d-flex justify-content-end mr-3">
                            <button className="btn btn-primary" onClick={this.downloadAllorders}>
