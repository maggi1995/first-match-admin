                        ...
                        {token ? (
                            <ul className="navbar-nav mr-right">
                                <li className="nav-item">
                                    <Link className="btn btn-primary" to="/admin/org-configure/">
                                ...
                                {is_pwd_updated === false ? (
                                    ...
                                    <>
                                        <li className="nav-item">
                                            <Link className="nav-link" to="/admin/configure">
                                                Configure
                                            </Link>
                                        </li>

                                        <li className="nav-item">
                                            <Link className="nav-link" to="/admin/eiflist">
                                                Interest Forms
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link" to="/admin/raflist">
                                                Assessment Forms
                                            </Link>
                                        </li>
                                    </>
