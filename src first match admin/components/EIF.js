...
export class EIF extends React.Component {
    ...
    display = () => {
        const display =
            this.props.loadquestions.response &&
            this.props.loadquestions.response.map((data, idx) =>
                data.question_type === 'TEXT' ? (
                    ...
                    data.suggested_answers.map((suggested, idy) => (
                        <div className="form-group form-check">
                            ...
                            <input className="form-check-input" id="check" type="checkbox" name={suggested.question_id} value={suggested.answer} onChange={this.handleCheckboxChange} required />{' '}
                            {suggested.answer}
                        </div>
                    ))
                )
        ...
        return (
            <div className="cotainer">
                <div className="text-center">
                    <h2>EXPRESS INTREST FORM</h2>
                </div>
                <div className="shadow-lg p-3 mb-5 bg-white rounded">
                    <div className="text-center col-sm text-primary">
                        Do you offer solutions to at-risk youth? Are you interested to know on how Artificial Intelligence can tranform the outcomes? Then fill in the INTEREST FORM below.
                    </div>
                    ...
                    <form className="m-4" onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group row d-flex justify-content-center">
                            ...
                            <div className="col-sm-6 d-flex justify-content-center">
                                <button type="submit" className="btn btn-primary btn btn-block">
                                    Submit
                                </button>
                            </div>
                            <div className="col-sm-3  ">&nbsp;</div>
