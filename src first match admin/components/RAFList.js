...
export class RAFList extends React.Component {
    ...
    render() {
        toast.configure();
        let { listID, success, username, password, list_status, loading, domain_updated, list_type } = this.state;
        ...
        if (listID !== '') {
                                ...
                                r.questions.map((q) =>
                                    q.answers.map((z) => (
                                        <li className="list-group-item mb-1">
                                            ...
                                            {z.answer.includes('static/') ? (
                                                <a href={`${baseApiUrl}/${z.answer}`} className="font-weight-bold">
                                                    View File
                                                </a>
                                            ) : (
                                                <span className="text-primary font-weight-bold">{z.answer}</span>
                                            )}
                                        </li>
                                    ))
                                )
                    ...
                    {list_status === true ? (
                        ...
                        <div className="form-group row mt-3 mb-3">
                            ...
                            <div className="col-sm-3 d-flex justify-content-center">
                                <button type="submit" value="resend" className="btn btn-primary pr-5 pl-5" onClick={(e) => this.resend_raf(e, 'value')}>
                                    Resend
                                </button>
                            </div>
                            {list_type !== 'drafts' && (
            ...
            if (success !== '') {
                return (
                    <div className="container-fluid">
                        <div className="row p-2 bg-primary text-white">New Organization Details</div>
                        <br />
                            ...
                            <div className=" ml-4">
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-4">
                                        <input type="text" className="form-control" id="validationDefault01" onChange={this.handleChange} value={this.state.domain} name="domain" required />
                                    </div>
                                </div>
                                <div className="form-group row">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-4">
                                        <button type="submit" disabled={!domain_updated} className="btn btn-primary font-weight-bold btn-block">
                                            Update Domain
                                        </button>
                                    </div>
                                </div>
                ...
                return (
                    <div className="container-fluid">
                            ...
                            <div className="row p-2 bd-highlight align">
                                ...
                                <div className="form-group  col-3 ">
                                    <select name="list_type" className="form-control" id="exampleFormControlSelect1" onChange={this.listChange} required>
                                        <option value="submitted" selected={this.state.list_type === 'submitted'}>
                                            Submitted
                                        </option>
                                        <option value="drafts" selected={this.state.list_type === 'drafts'}>
                                            Saved
                                        </option>
                                    </select>
                                </div>
                        ...
                        <ul className="list-group">
                            {this.state.RafList.response &&
                                this.state.RafList.response.map((ques, index) => (
                                        ...
                                        {list_type !== 'drafts' && (
                                            <>
                                                ...
                                                <span className="text-primary font-weight-bold">
                                                    {ques.is_approved === ques.is_rejected ? 'Pending' : ques.is_approved !== true ? 'Rejected' : 'Approved'}
                                                </span>
                                            </>
                                        )}
                                    </li>
