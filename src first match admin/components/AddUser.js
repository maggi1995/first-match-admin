    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                <div className="row p-2 bg-primary text-white">{id ? 'Edit' : 'Add'} User</div>
                <br />
                    ...
                    <div className=" ml-4">
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                <input type="text" className="form-control" id="validationDefault01" onChange={this.handleChange} value={this.state.first_name} name="first_name" required />
                            </div>
                        </div>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                <input type="text" onChange={this.handleChange} value={this.state.last_name} name="last_name" className="form-control " placeholder="" required />
                                {this.state.error['last_name'] && <span className="text-center text-danger">{this.state.error['last_name']}</span>}
                            </div>
                        </div>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                ...
                                {this.state.error['email_id'] && <span className="text-center text-danger">{this.state.error['email_id']}</span>}
                            </div>
                        </div>
                        <fieldset className="form-group">
                            <div className="row">
                                ...
                                <div className="col-sm-10">
                                    ...
                                    <div className="form-check form-check-inline">
                                        <input onChange={this.onRadioChange} className="form-check-input" name="gender" type="radio" value="2" id="male" checked={this.state.gender === '2'} required />
                                        <label className="form-check-label">Male</label>
                                        {this.state.error['gender'] && <span className="text-center text-danger ml-5">{this.state.error['gender']}</span>}
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                ...
                                {this.state.error['mobile'] && <span className="text-center text-danger">{this.state.error['mobile']}</span>}
                            </div>
                        </div>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-4">
                                <select name="group_id" className="form-control" id="exampleFormControlSelect1" onChange={this.handleChange} required>
                                    ...
                                    {this.state.Roles.map((role, i) => (
                                        <option key={i} value={role.id} selected={this.state.role_type === role.name}>
                                            {role.name}
                                        </option>
                                    ))}
                                </select>
                            </div>
                            {this.state.error['group_id'] && <div className="text-center text-danger">{this.state.error['group_id']}</div>}
                        </div>
                        <div className="form-group row">
