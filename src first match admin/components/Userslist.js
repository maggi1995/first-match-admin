                                ...
                                this.state.Users.map((ques, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="text-center">
                                            {(role_type === 'Coordinator' ? '-' : role_type === 'Admin' && (ques.role_type === 'Super Admin' || ques.role_type === 'Admin')) ? (
                                                '-'
                                            ) : (
                                                <i
                                        ...
                                        <td className="text-center">
                                            {(role_type === 'Coordinator' ? '-' : role_type === 'Admin' && (ques.role_type === 'Super Admin' || ques.role_type === 'Admin')) ? (
                                                ...
                                                <i
                                                    ...
                                                    data-id={ques.id}
                                                    onClick={(e) => window.confirm('Are you sure you wish to delete this User?') && this.handleDelete(e)}
                                                ></i>
                                            )}
                                        </td>
                                    </tr>
